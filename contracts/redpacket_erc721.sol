...
contract HappyRedPacket_ERC721 is Initializable {
    ...
    function claim(
        ...
        (claimed_index, claimed_token_id, new_bit_status, new_remaining_tokens) = _get_token_index(
    ...
    function check_claimed_id(bytes32 id) external view returns (uint256 claimed_token_id) {
